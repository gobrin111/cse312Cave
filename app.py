...
def get_messages(): #done
    ...
    for message in messages:
        ...
        message_display.append({
            ...
            "like_number": like_collection.count_documents({"message_id": str(message["_id"])})
        })
        print("here")
        print(like_collection.count_documents({"message_id": str(message["_id"])}))
...
@app.route('/chat-messages/like/<message_id>', methods=['POST'])
