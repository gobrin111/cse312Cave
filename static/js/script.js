...
function chatMessageHTML(messageJSON) {
    ...
    let messageHTML = "<div class='message-container' id='message_"+messageId+"'> <button onclick='deleteMessage(\""+messageId+"\")'>X</button>" + username +": <br/> <div style='background-color: " + color + "'>"+message+"</div> </div>"
    return messageHTML
