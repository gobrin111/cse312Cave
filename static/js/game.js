            ...
            if (currentCol == 5) {
                isWord(input[currentRow].join('')).then(result => {
                    if (result) {
                        ...
                        if (input[currentRow].join('') == "JESSE") {
                            let easterEggAudio = document.getElementById("easter-egg");
                            easterEggAudio.innerHTML = `
                                <audio autoplay loop>
                                    <source src="static/audios/BB Intro.ogg" type="audio/ogg">
                                    <source src="static/audios/BB Intro.mp3" type="audio/mpeg">
                                </audio>
                            `
                            document.getElementById("easter-egg-image").style.display = "block";
                        }
